...
#POST
Invoke-RestMethod -Uri $url -Method 'Post' -Authentication 'Basic' \
                  -Credential $credentials -ContentType 'application/json' \
                  -SkipCertificateCheck -body '{"value":"Active"}' -Verbose

#GET
Invoke-RestMethod -Uri $url -Method 'Get' -Authentication 'Basic' \
                  -Credential $credentials -ContentType 'application/json' \
                  -SkipCertificateCheck -verbose | Write-Host
